...
as a generic matrix. `factorize` checks every element of `A` to verify/disqualify
each property. The return value can be reused for efficient solving of multiple
